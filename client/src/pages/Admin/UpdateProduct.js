...
const UpdateProduct = () => {
  ...
  const handleUpdate = async (e) => {
    ...
    try {
      ...
      const { data } = axios.put(`${process.env.REACT_APP_BACKEND_URL}/api/v1/product/update-product/${id}`, productData);
      if (data?.success) {
        ...
        <div className="row">
          ...
          <div className="col-md-9">
            ...
            <div className="m-1 w-75">
              ...
              <div className="mb-3">
                <input type="text" value={name} placeholder="write Name of the Book" className="form-control" onChange={(e) => setName(e.target.value)} />
              </div>
              <div className="mb-3">
                <input type="text" value={author} placeholder="write Author of the Book" className="form-control" onChange={(e) => setAuthor(e.target.value)} />
              </div>
              <div className="mb-3">
