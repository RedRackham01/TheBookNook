...
const HomePage = () => {
  ...
  return (
    <Layout>
      {/* banner image */}
      <img src="/images/bookshelf.jpg" className="banner-img" alt="bannerimage" width={"100%"} />
      {/* banner image */}
      <div className="container-fluid row mt-3 home-page">
        <div className="col-md-2 filters">
          <h4 className="text-center">Filter By Genre</h4>
          <div className="d-flex flex-column catfilt">
            {categories?.map((c) => (
        ...
        <div className="col-md-10 mt-3">
          {/* <h1 className="text-center">All Books Available</h1> */}
          ...
          <div className="m-2 p-3 d-flex justify-content-center">
            {!filters && products && products.length < total && (
              <button
